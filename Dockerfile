...
RUN wget -O xrt_201910.2.2.2250_7.4.1708 https://nextcloud.nautilus.optiputer.net/s/EqQFSPq6MqASYSq/download && \
https://nextcloud.nautilus.optiputer.net/s/X4BMG5jNoAmA26Q
...
RUN yum clean all && yum -y install xrt_201920.2.3.1301_7.4.1708-xrt.rpm \
    xilinx-u200-xdma-201830.2-2580015.x86_64.rpm \
    xilinx-u200-xdma-dev-201830.2-2580015.x86_64.rpm && \
    rm -rf xrt_201920.2.3.1301_7.4.1708-xrt.rpm \
    xilinx-u200-xdma-201830.2-2580015.x86_64.rpm \
    xilinx-u200-xdma-dev-201830.2-2580015.x86_64.rpm
